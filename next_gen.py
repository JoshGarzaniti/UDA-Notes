...
next_gen_data = next_gen_req.json() #javascript object notation
...
next_gen_data['leaders'] #grab the column name of the varbiable we want to extract
...
pd.concat([df_leader, df_play], axis=1) #python's version of rcbind
