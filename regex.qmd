...
# Find all of the data matching this
found_numbers = re.findall(r'\d+', string)
print("Found numbers:", found_numbers)

# Substitute \d+ for 'X'
substituted_string = re.sub(r'\d+', 'X', string)
print("String with substituted numbers:", substituted_string)

# Split this string into \d+ parts
split_string = re.split(r'\d+', string)
print("Split string:", split_string)

# Tell us if we have matched this and where it is
match_result = re.match(r'\d+', string)
...
```{python}
lyrics_df['lyrics'].str.replace(r'^\s|\s$', ' ', regex=True)
```
...
```{python}
lyrics_df['lyrics'].str.replace(r'([a-z])([A-Z])', r'\1 \2', regex=True)
```
